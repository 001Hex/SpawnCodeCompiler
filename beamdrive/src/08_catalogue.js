  ...
  var VEHICLES = [
    ...
    /* ------------------------------------------------ 1. Comet Hatch ---- */
    {
      ...
      gearbox: { final: 4.05, ratios: [-3.55, 0, 3.45, 1.95, 1.28, 0.95, 0.76],
                 shiftTime: 0.34, autoUp: 0.90, autoDown: 0.42 },
      ...
      aero: { drag: 0.62, lift: -0.05, frontal: 2.05 },
    ...
    /* ----------------------------------------------- 2. Meridian Sedan -- */
    {
      ...
      gearbox: { final: 3.62, ratios: [-3.20, 0, 3.30, 2.05, 1.42, 1.03, 0.79, 0.64],
                 shiftTime: 0.30, autoUp: 0.86, autoDown: 0.38 },
      ...
      aero: { drag: 0.58, lift: -0.08, frontal: 2.20 },
    ...
    /* ------------------------------------------------- 3. Rampage GT ---- */
    {
      ...
      gearbox: { final: 3.31, ratios: [-2.90, 0, 2.66, 1.78, 1.30, 1.00, 0.80, 0.63],
                 shiftTime: 0.22, autoUp: 0.94, autoDown: 0.44 },
      ...
      aero: { drag: 0.60, lift: -0.18, frontal: 2.28 },
    ...
    /* -------------------------------------------------- 4. Bighorn 4x4 -- */
    {
      ...
      gearbox: { final: 3.92, ratios: [-3.10, 0, 3.80, 2.20, 1.50, 1.10, 0.85, 0.68],
                 shiftTime: 0.42, autoUp: 0.80, autoDown: 0.34 },
      ...
      aero: { drag: 0.92, lift: 0.04, frontal: 3.30 },
    ...
    /* ---------------------------------------------------- 5. Vector RS -- */
    {
      ...
      gearbox: { final: 3.75, ratios: [-3.00, 0, 3.10, 2.12, 1.58, 1.24, 1.00, 0.82, 0.68],
                 shiftTime: 0.13, autoUp: 0.96, autoDown: 0.46 },
      ...
      aero: { drag: 0.52, lift: -0.42, frontal: 1.90 },
    ...
    /* -------------------------------------------------- 6. Sprint Rally - */
    {
      ...
      gearbox: { final: 4.10, ratios: [-3.40, 0, 3.25, 2.10, 1.55, 1.18, 0.94, 0.78],
                 shiftTime: 0.16, autoUp: 0.94, autoDown: 0.46 },
      ...
      aero: { drag: 0.66, lift: -0.22, frontal: 2.12 },
